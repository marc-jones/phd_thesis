...
The expression of the gene was found to decrease during vernalization in a quantitative manner, with the more cold the plant experienced, the less the gene was expressed[@michaels_flowering_1999].
...
Understanding the requirement for cold is therefore a key part of any analysis of flowering time control in the crop.
...
In *B.\ rapa*, as in *B.\ napus*[@osborn_comparison_1997], an *FLC* copy on chromosome A2 emerged as a candidate underlying flowering time variation[@lou_quantitative_2007; @osborn_comparison_1997; @kole_evidence_2001; @xiao_brassica_2013; @zhao_brflc2_2010].
...
If different cis-regulatory elements are required for gene expression in different tissues, then over time mutations in these cis-regulatory elements would result in tissue-specific expression of the genes.
...
Specifically, which vernalization pathway genes are candidates for mediating the vernalization requirement in Tapidor and is there tissue specificity in expression.
