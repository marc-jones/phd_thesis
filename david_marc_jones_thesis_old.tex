...
\begin{figure}[htbp]
\centering
\includegraphics{../content/01_introduction/figures/network_duplication.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/01_sampling_scheme.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/02_gene_position.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/03_gene_length.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/04_tissue_split_sequencing_fpkm.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/05_tissue_split_sequencing_confidence_interval.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/06_both_vs_first_sequencing_fpkm.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/07_both_vs_first_sequencing_conf_interval.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/08_all_vs_unique_sequencing_fpkm.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/09_all_vs_unique_sequencing_conf_interval.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10b_som_explanation.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10c_a_w_som_count.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10d_l_w_som_count.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10e_go_term_enrichment_1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10f_go_term_enrichment_2.pdf}
\caption{\textbf{Normalized expression profiles for SOM clusters
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10g_go_term_enrichment_3.pdf}
\caption{\textbf{Normalized expression profiles for SOM clusters
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10h_protein_enrichment.pdf}
\caption{\textbf{Normalized expression profiles for SOM clusters
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/10i_genome_level.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/11_expressed_gene_venn_diagram.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/12_retention_distributions.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/13_all_vs_exp_all_genes.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/14_all_vs_exp_flower_genes.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/15_wgcna_cluster_all_genes.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/16_wgcna_cluster_flower_genes.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/18_som_similarity_measure.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/23_exp_ft_leaf.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/25_exp_ft_apex.pdf}
\caption{\textbf{Expression traces for the \emph{BnFT} genes in the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/26_exp_ap1_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/27_exp_soc1_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/29_exp_agl24_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/28_exp_soc1_leaf.pdf}
\caption{\textbf{Expression traces for the \emph{BnSOC1} genes in the
Westar leaf.} The expression values in FPKM and the 95~\% confidence
intervals of those expression values as computed by Cufflinks are
displayed. A heatmap of the clustering coefficients calculated by the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/30_exp_fd_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/31_exp_lfy_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/32_exp_tfl1_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/33_sequence_conservation_qpcr.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/bzip.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/34_brassica_sequence_alignment.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/35_protein_structure.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/brassica_zipper_alignment_with_charges.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/36_helical_wheels.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/37_fd_dimer_heatmap.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/38_ensembl_with_heatmap.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/39_brassica_wheat_maize_fd.pdf}
\caption{\textbf{Multiple sequence alignment of the leucine zipper
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/02_spring/figures/40_fd_dimerization.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/variety_venn_diagram.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/tap_vs_wes_exp_all.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/tap_vs_wes_exp_flowering.pdf}
\caption{\textbf{Relationship between the number of expressed copies of
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/var_specific_distribution_all.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/var_specific_distribution_flowering.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/tapidor_apex_som.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/tapidor_leaf_som.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/apex_correlation.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/leaf_correlation.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/apex_tapidor_flc.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/apex_westar_flc.pdf}
\caption{\textbf{Expression traces for the \emph{BnFLC} genes in the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/flc_comparison_apex_1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/flc_comparison_apex_2.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/leaf_tapidor_flc.pdf}
\caption{\textbf{Expression traces for the \emph{BnFLC} genes in the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/leaf_westar_flc.pdf}
\caption{\textbf{Expression traces for the \emph{BnFLC} genes in the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/flc_comparison_leaf.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/vrn2_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/vrn2_leaf.pdf}
\caption{\textbf{Expression traces for the \emph{BnVRN2} genes in the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/msi1_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/msi1_leaf.pdf}
\caption{\textbf{Expression traces for the \emph{BnMSI1} genes in the
leaf.} The expression values and the 95\% confidence intervals of those
expression values as computed by Cufflinks are displayed. Largely
similar patterns of expression are observed between the two varieties,
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/apex_vin3.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/leaf_vin3.pdf}
\caption{\textbf{Expression traces for the \emph{BnVIN3} genes in the
leaf.} The expression values and the 95\% confidence intervals of those
expression values as computed by Cufflinks are displayed. A heatmap of
the clustering coefficients calculated by the SOM based method
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/fri_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/fri_leaf.pdf}
\caption{\textbf{Expression traces for the \emph{BnFRI} genes in the
leaf.} The expression values and the 95\% confidence intervals of those
expression values as computed by Cufflinks are displayed. Expression of
all copies are very low, with the A10 copy being expressed below the 2.0
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/exp_ft_leaf.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/exp_tfl1_apex.pdf}
\caption{\textbf{Expression traces for the \emph{BnTFL1} genes in the
apex of Tapidor.} The expression values and the 95\% confidence
intervals of those expression values as computed by Cufflinks are
displayed. A heatmap of the clustering coefficients calculated by the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/apex_leaf_fd.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/exp_ap1_apex.pdf}
\caption{\textbf{Expression traces for the \emph{BnAP1} genes in the
apex of Tapidor.} The expression values and the 95\% confidence
intervals of those expression values as computed by Cufflinks are
displayed. A heatmap of the clustering coefficients calculated by the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/apex_soc1.pdf}
\caption{\textbf{Expression traces for the \emph{BnSOC1} genes in the
apex of Tapidor.} The expression values and the 95\% confidence
intervals of those expression values as computed by Cufflinks are
displayed. A heatmap of the clustering coefficients calculated by the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/leaf_soc1.pdf}
\caption{\textbf{Expression traces for the \emph{BnSOC1} genes in the
leaf of Tapidor.} The expression values and the 95\% confidence
intervals of those expression values as computed by Cufflinks are
displayed. A heatmap of the clustering coefficients calculated by the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/apex_lfy.pdf}
\caption{\textbf{Expression traces for the \emph{BnLFY} genes in the
apex of Tapidor.} The expression values and the 95\% confidence
intervals of those expression values as computed by Cufflinks are
displayed. A heatmap of the clustering coefficients calculated by the
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/03_winter/figures/discussion_figure.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/04_website/figures/01_database_structure.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/04_website/figures/02_expression_screen.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/04_website/figures/03_blast_screen.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/04_website/figures/04_table_screen.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/04_website/figures/agl24_vs_ap1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/04_website/figures/MIR156a.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/04_website/figures/MIR172a.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/06_materials_and_methods/figures/homoeologue_plots.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/06_materials_and_methods/figures/self_clustering.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/08_appendix_a/figures/qa_plots.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/08_appendix_a/figures/plots_supp_fig.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/08_appendix_a/figures/homoeologue_supp_fig.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/08_appendix_a/figures/westar_svp.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/09_appendix_b/figures/fie1_leaf.pdf}
\caption{\textbf{FIE1 Leaf}}\label{figure:3xx:fie1msi1leaf}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{../content/09_appendix_b/figures/fie1_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/09_appendix_b/figures/eza1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/09_appendix_b/figures/vil1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/09_appendix_b/figures/vil2_apex.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{../content/09_appendix_b/figures/vil2_leaf.pdf}
